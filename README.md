...
Данный скрипт является оберткой над утилитами из [TIS Linux SDK](https://github.com/TheImagingSource/tiscamera), т.е. для работы скрипта этот SDK должен быть установлен.
